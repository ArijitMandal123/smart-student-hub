                  ...
                  <div className="absolute right-0 mt-3 w-80 bg-white/95 backdrop-blur-xl text-black rounded-2xl shadow-2xl border border-white/20 z-50 animate-slideUp">
                    <div className="p-6">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className={`w-3 h-3 rounded-full ${backendStatus.includes('success') ? 'bg-green-500' : 'bg-red-500'}`}></div>
                  ...
                  <div className="absolute right-0 mt-3 w-96 bg-white/95 backdrop-blur-xl text-black rounded-2xl shadow-2xl border border-white/20 z-50 max-h-96 overflow-hidden animate-slideUp">
                    <div className="p-6 border-b border-gray-100">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">{messages.length} total</span>
                      </div>
                    </div>
                    <div className="max-h-80 overflow-y-auto">
                      {messages.length === 0 ? (
                        <div className="p-8 text-center text-gray-500">
                          ...
                          <p className="text-sm text-gray-400 mt-1">Messages from teachers will appear here</p>
                        </div>
                      ) : (
                        messages.map((message) => (
                          <div 
                            ...
                            className={`p-4 border-b border-gray-100 hover:bg-blue-50 cursor-pointer transition-all duration-200 ${
                              !message.isRead ? 'bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-l-blue-500' : ''
                            }`}
                            onClick={async () => {
                              if (!message.isRead) {
                                try {
                                  await api.put(`/api/messages/${message._id}/read/${studentData.studentId}`);
                            ...
                            <div className="flex items-start justify-between mb-3">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{message.groupName}</p>
                                </div>
                              </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="bg-blue-100 px-4 py-2 rounded-full">
                      <p className="text-blue-800 font-semibold text-sm">ID: {studentData?.studentId}</p>
                    </div>
                    <div className="bg-green-100 px-4 py-2 rounded-full">
                      <p className="text-green-800 font-semibold text-sm">Active Student</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-blue-700 transition-colors">Academic Records</h3>
              <p className="text-gray-600 leading-relaxed">View your academic performance and track your progress</p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-green-700 transition-colors">Academic Certificates</h3>
              <p className="text-gray-600 leading-relaxed">Manage and showcase your academic achievements</p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-orange-700 transition-colors">Personal Achievements</h3>
              <p className="text-gray-600 leading-relaxed">Track your personal certificates and accomplishments</p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-purple-700 transition-colors">Profile Management</h3>
              <p className="text-gray-600 leading-relaxed">Update your personal details and documents</p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-indigo-700 transition-colors">Project Portfolio</h3>
              <p className="text-gray-600 leading-relaxed">Showcase your projects and technical work</p>
